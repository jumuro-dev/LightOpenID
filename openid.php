 ...
 * 
 * It requires PHP >= 5.6 with cURL or HTTP/HTTPS stream wrappers enabled.
 *
 * @property null mode
 * @version     v1.3.2 (2018-01-22)
 * @link        https://code.google.com/p/lightopenid/          Project URL
 * @link        https://github.com/jumuro-dev/LightOpenID       GitHub Repo
...
class LightOpenID
{
	...
	protected function request($url, $method='GET', $params=[], $update_claimed_id=false)
    {
        ...
        if (function_exists('curl_init')) {
            ...
            if (!$use_curl) {
                # When there is no HTTPS wrapper, PHP streams cannot be used.
